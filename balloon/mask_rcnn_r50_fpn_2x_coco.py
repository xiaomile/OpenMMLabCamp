...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='data/balloon/train/via_region_data_coco.json',
...
log_level = 'INFO'
load_from = '/HOME/scz0bbt/run/mmdetection/mask_rcnn_r50_fpn_2x_coco_bbox_mAP-0.392__segm_mAP-0.354_20200505_003907-3e542a40.pth'
resume_from = None
workflow = [('train', 1)]
